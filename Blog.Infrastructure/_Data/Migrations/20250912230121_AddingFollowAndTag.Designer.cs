...
namespace Blog.Infrastructure._Data.Migrations
{
    ...
    [Migration("20250912230121_AddingFollowAndTag")]
    partial class AddingFollowAndTag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Core.Entities.Follow", b =>
                {
            ...
            modelBuilder.Entity("Blog.Core.Entities.Post_Aggregate.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blog.Core.Entities.Comment", b =>
                {
                    b.HasOne("Blog.Core.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany("Comments")
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("Blog.Core.Entities.Post_Aggregate.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Blog.Core.Entities.Follow", b =>
                {
                    b.HasOne("Blog.Core.Entities.ApplicationUser", "Followed")
                        .WithMany("Followers")
                        .HasForeignKey("FollowedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Blog.Core.Entities.ApplicationUser", "Follower")
                        .WithMany("Following")
